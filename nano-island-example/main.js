...
function defineIslandPlugin(factory) {
  ...
  if (host._currentPlugin && host._env) {
    host._currentPlugin.factory = factory;
  } else {
    console.warn("[Nano Island] 插件未在加载流程中调用");
  }
}
/**
* @vue/shared v3.5.33
...
function useTemplateRef(key) {
  ...
  const ret = false ? /* @__PURE__ */ readonly(r) : r;
  if (false) {
...
const publicPropertiesMap = (
  ...
  /* @__PURE__ */ extend(/* @__PURE__ */ Object.create(null), {
    ...
    $el: (i) => i.vnode.el,
    $data: (i) => i.data,
    $props: (i) => false ? /* @__PURE__ */ shallowReadonly(i.props) : i.props,
    $attrs: (i) => false ? /* @__PURE__ */ shallowReadonly(i.attrs) : i.attrs,
    $slots: (i) => false ? /* @__PURE__ */ shallowReadonly(i.slots) : i.slots,
    $refs: (i) => false ? /* @__PURE__ */ shallowReadonly(i.refs) : i.refs,
...
function validateProps(rawProps, props, instance) {
  ...
  for (const key in options) {
    ...
    validateProp(
      ...
      resolvedValues[key],
      opt,
      false ? /* @__PURE__ */ shallowReadonly(resolvedValues) : resolvedValues,
...
function setupStatefulComponent(instance, isSSR) {
  ...
  if (setup) {
    ...
    const setupResult = callWithErrorHandling(
      ...
      0,
      [
        false ? /* @__PURE__ */ shallowReadonly(instance.props) : instance.props,
        setupContext
      ]
    );
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const time = /* @__PURE__ */ ref("");
    const date = /* @__PURE__ */ ref("");
    const timezone = /* @__PURE__ */ ref("Asia/Shanghai");
    function updateDateTime() {
      const now = /* @__PURE__ */ new Date();
      const hours = now.getHours().toString().padStart(2, "0");
      const minutes = now.getMinutes().toString().padStart(2, "0");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        ...
        _cache[0] || (_cache[0] = createBaseVNode("div", { class: "flex justify-between items-center text-sm opacity-80" }, [
          ...
          createBaseVNode("div", null, "v1.0.0")
        ], -1))
      ]);
    };
  }
  ...
  setup(__props) {
    ...
    function updateTime() {
      ...
      if (hours < 6) {
        ...
        greeting.value = "☀️ 上午好";
      } else if (hours < 14) {
        greeting.value = "🌞 中午好";
      } else if (hours < 18) {
        greeting.value = "🌤️ 下午好";
      } else if (hours < 22) {
        greeting.value = "🌆 傍晚好";
      } else {
        greeting.value = "🌙 晚上好";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        ...
        _cache[1] || (_cache[1] = createBaseVNode("div", { class: "text-xs opacity-70 flex justify-between" }, [
          createBaseVNode("span", null, "示例时钟插件"),
          createBaseVNode("span", null, "v1.0.0")
        ], -1))
      ]);
    };
  }
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    var _a, _b;
    const props = __props;
    const theme = /* @__PURE__ */ ref(((_a = props.defaultProps) == null ? void 0 : _a.theme) || "dark");
    const format = /* @__PURE__ */ ref(((_b = props.defaultProps) == null ? void 0 : _b.format) || "24h");
    ...
    function saveSettings() {
      ...
      window.parent.postMessage({
        type: "plugin-settings-close",
        pluginId: "nano-island-example"
      }, "*");
    }
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
          ...
          createBaseVNode("div", _hoisted_3$1, [
            ...
            createBaseVNode("div", _hoisted_4$1, [
              createBaseVNode("button", {
                ...
                createBaseVNode("div", { class: "text-2xl mb-1" }, "☀️", -1),
                createBaseVNode("div", { class: "text-sm text-gray-700 dark:text-gray-300" }, "浅色", -1)
              ])], 2),
              createBaseVNode("button", {
                onClick: _cache[1] || (_cache[1] = ($event) => theme.value = "dark"),
                class: normalizeClass(["flex-1 py-3 px-4 rounded-lg border-2 transition-all", theme.value === "dark" ? "border-purple-500 bg-purple-50 dark:bg-purple-900/20" : "border-gray-200 dark:border-gray-700 hover:border-gray-300"])
              }, [..._cache[8] || (_cache[8] = [
                createBaseVNode("div", { class: "text-2xl mb-1" }, "🌙", -1),
                createBaseVNode("div", { class: "text-sm text-gray-700 dark:text-gray-300" }, "深色", -1)
              ])], 2),
              createBaseVNode("button", {
                onClick: _cache[2] || (_cache[2] = ($event) => theme.value = "auto"),
                class: normalizeClass(["flex-1 py-3 px-4 rounded-lg border-2 transition-all", theme.value === "auto" ? "border-purple-500 bg-purple-50 dark:bg-purple-900/20" : "border-gray-200 dark:border-gray-700 hover:border-gray-300"])
              }, [..._cache[9] || (_cache[9] = [
                createBaseVNode("div", { class: "text-2xl mb-1" }, "🔄", -1),
                createBaseVNode("div", { class: "text-sm text-gray-700 dark:text-gray-300" }, "自动", -1)
              ])], 2)
            ])
          ]),
          createBaseVNode("div", _hoisted_5$1, [
            ...
            createBaseVNode("div", _hoisted_6$1, [
              createBaseVNode("button", {
                ...
                createBaseVNode("div", { class: "text-sm font-mono text-gray-700 dark:text-gray-300" }, "12:00", -1),
                createBaseVNode("div", { class: "text-xs text-gray-500 mt-1" }, "12小时制", -1)
              ])], 2),
              createBaseVNode("button", {
                onClick: _cache[4] || (_cache[4] = ($event) => format.value = "24h"),
                class: normalizeClass(["flex-1 py-3 px-4 rounded-lg border-2 transition-all", format.value === "24h" ? "border-purple-500 bg-purple-50 dark:bg-purple-900/20" : "border-gray-200 dark:border-gray-700 hover:border-gray-300"])
              }, [..._cache[12] || (_cache[12] = [
                createBaseVNode("div", { class: "text-sm font-mono text-gray-700 dark:text-gray-300" }, "24:00", -1),
                createBaseVNode("div", { class: "text-xs text-gray-500 mt-1" }, "24小时制", -1)
              ])], 2)
            ])
          ]),
          createBaseVNode("div", _hoisted_7$1, [
            ...
            createBaseVNode("label", _hoisted_8$1, [
              ...
              createBaseVNode("div", {
                ...
                class: normalizeClass(["relative w-12 h-6 rounded-full transition-colors", showSeconds.value ? "bg-purple-500" : "bg-gray-300"])
              }, [
                createBaseVNode("div", {
        ...
        createBaseVNode("div", { class: "px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-between" }, [
          createBaseVNode("button", {
...
const main = defineIslandPlugin((ctx) => {
  console.log("[Example Plugin] 开始初始化插件");
  const myManifest = ctx.getManifest();
  console.log("[Example Plugin] 当前插件的 Manifest:", {
    id: myManifest.id,
    name: myManifest.name,
    version: myManifest.version,
    isOfficial: myManifest.isOfficial,
    isReleased: myManifest.isReleased
  });
  ...
  ctx.onMount(() => {
    ...
    const currentPlugin = ctx.getPlugin(ctx.pluginId);
    console.log("[Example Plugin] 当前插件完整信息:", currentPlugin);
    const officialPlugins = ctx.getAllPlugins().filter((p2) => p2.manifest.isOfficial);
    console.log("[Example Plugin] 官方插件列表:", officialPlugins);
  });
  ctx.onEnable(async () => {
    console.log("[Example Plugin] 插件已启用");
  ...
  ctx.onDisable(() => {
    console.log("[Example Plugin] 插件已禁用");
  });
  ctx.onUninstall(() => {
